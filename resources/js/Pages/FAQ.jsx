...
export default function FAQ() {
  ...
  useEffect(() => {
    ...
    // FAQ items animation - stagger with slide from left
    gsap.fromTo(
      faqItemsRef.current,
      { opacity: 0, x: -30 },
      {
      ...
      <div className="w-full font-sans bg-white">
        ...
        <section className="px-4 sm:px-10 lg:px-0 pb-20 sm:pb-28">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
            ...
            <div
              ref={sidePanelRef}
              className="hidden lg:block lg:col-span-4 sticky top-28"
            >
              <div className="rounded-2xl overflow-hidden">
                <img
                  src="/images/logo.jpeg"
            ...
            {/* FAQ accordion */}
            <div ref={faqContainerRef} className="lg:col-span-8 flex flex-col border-t border-gray-200">
              {faqs.map((faq, index) => {
                const isOpen = index === openIndex;
                return (
                  <div
